...
Volume Control — System volume adjusted via hand gesture (pinch distance mapped to volume level)
Workout Rep Counter (pose_gym_count.py) — Counts exercise repetitions automatically by tracking body pose landmarks
